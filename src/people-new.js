...
let logger = LogManager.getLogger('people-new');
...
export class PeopleNew {
  ...
  activate(params, routeConfig, navigationInstruction) {
    if (environment.debug) logger.info(`edit contact ${params.email}`);
  }

  save() {
    this.router.navigateToRoute('people-show', { email: this.contact.email })
  }
}
